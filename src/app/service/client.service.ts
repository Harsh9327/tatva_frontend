...
export class ClientService {
  ...
  MissionList(userId: any): Observable<Mission[]> {
    return this.http.get<Mission[]>(
      `${this.apiUrl}/ClientMission/ClientSideMissionList/${userId}`
    );
  }
  MissionClientList(data: any) {
    return this.http.post(
      `${this.apiUrl}/ClientMission/MissionClientList`,
      data
    );
  }
  MissionDetailByMissionId(data: any) {
    return this.http.post(
      `${this.apiUrl}/ClientMission/MissionDetailByMissionId/`,
      data
    );
  }
  ...
  LoginUserDetailById(id: any): Observable<user[]> {
    return this.http.get<user[]>(
      `${this.apiUrl}/Login/LoginUserDetailById/${id}`
    );
  }
  ...
  LoginUserProfileUpdate(userDetail: UserDetail) {
    return this.http.post(
      `${this.apiUrl}/Login/LoginUserProfileUpdate`,
      userDetail
    );
  }
  ...
  GetUserProfileDetailById(userId: any) {
    return this.http.get<UserDetail[]>(
      `${this.apiUrl}/Login/GetUserProfileDetailById/${userId}`
    );
  }
  ...
  GetVolunteeringHoursList(userid: any): Observable<VolunteeringHours[]> {
    return this.http.get<VolunteeringHours[]>(
      `${this.apiUrl}/VolunteeringTimesheet/GetVolunteeringHoursList/${userid}`
    );
  }
  GetVolunteeringHoursById(id: number): Observable<VolunteeringHours[]> {
    return this.http.get<VolunteeringHours[]>(
      `${this.apiUrl}/VolunteeringTimesheet/GetVolunteeringHoursListById/${id}`
    );
  }

  VolunteeringMissionList(id: number): Observable<Mission[]> {
    return this.http.get<Mission[]>(
      `${this.apiUrl}/VolunteeringTimesheet/VolunteeringMissionList/${id}`
    );
  }
  AddVolunteeringHours(data: VolunteeringHours) {
    return this.http.post(
      `${this.apiUrl}/VolunteeringTimesheet/AddVolunteeringHours`,
      data
    );
  }
  UpdateVolunteeringHours(data: VolunteeringHours) {
    return this.http.post(
      `${this.apiUrl}/VolunteeringTimesheet/UpdateVolunteeringHours`,
      data
    );
  }
  DeleteVolunteeringHours(id: any) {
    return this.http.delete(
      `${this.apiUrl}/VolunteeringTimesheet/DeleteVolunteeringHours/${id}`
    );
  }

  //Volunteering Timesheet Goals
  GetVolunteeringGoalsList(userid: any): Observable<VolunteeringGoals[]> {
    return this.http.get<VolunteeringGoals[]>(
      `${this.apiUrl}/VolunteeringTimesheet/GetVolunteeringGoalsList/${userid}`
    );
  }
  GetVolunteeringGoalsById(id: number): Observable<VolunteeringGoals[]> {
    return this.http.get<VolunteeringGoals[]>(
      `${this.apiUrl}/VolunteeringTimesheet/GetVolunteeringGoalsListById/${id}`
    );
  }

  AddVolunteeringGoals(data: VolunteeringGoals) {
    return this.http.post(
      `${this.apiUrl}/VolunteeringTimesheet/AddVolunteeringGoals`,
      data
    );
  }
  UpdateVolunteeringGoals(data: VolunteeringGoals) {
    return this.http.post(
      `${this.apiUrl}/VolunteeringTimesheet/UpdateVolunteeringGoals`,
      data
    );
  }
  DeleteVolunteeringGoals(id: any) {
    return this.http.delete(
      `${this.apiUrl}/VolunteeringTimesheet/DeleteVolunteeringGoals/${id}`
    );
  }
  ...
  AddMissionComment(data: any) {
    return this.http.post(
      `${this.apiUrl}/ClientMission/AddMissionComment`,
      data
    );
  }
  MissionCommentListByMissionId(missionId: any): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.apiUrl}/ClientMission/MissionCommentListByMissionId/${missionId}`
    );
  }
  ...
  AddMissionFavourite(data: any) {
    return this.http.post(
      `${this.apiUrl}/ClientMission/AddMissionFavourite`,
      data
    );
  }
  RemoveMissionFavourite(data: any) {
    return this.http.post(
      `${this.apiUrl}/ClientMission/RemoveMissionFavourite`,
      data
    );
  }
  ...
  RecentVolunteerList(data: any) {
    return this.http.post(
      `${this.apiUrl}/ClientMission/RecentVolunteerList`,
      data
    );
  }
  ...
  GetUserList(userId: any): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.apiUrl}/ClientMission/GetUserList/${userId}`
    );
  }
  SendInviteMissionMail(data: any) {
    debugger;
    return this.http.post(
      `${this.apiUrl}/ClientMission/SendInviteMissionMail`,
      data
    );
  }
}
